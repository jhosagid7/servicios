...
?>
                      ...
                      if ( ! isset( $_GET['_comp'] ) AND $_GET['_comp'] === '1' ) {
  ...
  $hasta = $_GET['hasta'];
                          ...
                          $buscar=mysqli_query($conexion,"select v.id_ventas as codigo, pd.nombre_empresa_prod, pd.rif_prod, pd.nombre_contacto_prod, pd.cedula_contacto_prod, v.tipo_prod, v.litros, v.fecha from ventas  v, productores pd WHERE v.fecha BETWEEN '$desde' AND '{$hasta}'");
    
                          
                          $html = utf8_encode("<h1>Reporte general de ventas desde el $desde hasta el $hasta</h1>
                          ...
                          $html .= utf8_encode(
                            "<tbody><tr>
                              ...
                              <td>
                                ".$dato["nombre_empresa_prod"]." 
                              </td>
                              <td>
                                ".$dato["rif_prod"]."
                              </td>
                              <td>
                                ". $dato["nombre_contacto_prod"]."
                              </td>
                              <td>
                                ". $dato["cedula_contacto_prod"]."
                              </td>
                              <td>
                                ".$dato["tipo_prod"]."
                              </td>
