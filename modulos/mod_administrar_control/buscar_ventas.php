...
if ( ! isset( $_POST['_comp'] ) AND $_POST['_comp'] === '1' ) {
  ...
  $hasta = $_POST['hasta'];
    ...
    echo"<h1>Ver control</h1><a class='btn btn-danger small' href='" . BASE_URL . "modulos/mod_administrar_control/reporte_general_ventas_fecha_pdf.php?desde=".$desde."&hasta=".$hasta."&_comp=".$_comp."'>Descargar PDF</a>";
