                ...
                <table border="0">
                  <tr>
                    ...
                    <center>
                      ...
                      <p>
                        <h2>Modulo de Administraci&oacute;n de Ventas</h2><p>
                      </p>
                      ...
                      <p>
                        <input class="btn btn-info" type="submit" name="ingresar_ventas" value="Ingresar Venta">
                      </p>
                      <p>
                        <input class="btn btn-info" type="submit" name="ver_ventas"  value="Ver Venta">
                      </p>
                      <?php }else{ ?>
                      <p>
                        <input class="btn btn-info" type="submit" name="ver_ventas"  value="Ver Venta">
