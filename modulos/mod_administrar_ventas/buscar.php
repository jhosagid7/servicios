...
echo $v; exit;*/
$resultadoa=mysqli_query($conexion,"select * from proveedores where rif_prov='$rif_prov'");
if(mysqli_num_rows($resultadoa)>0){

$buscar=mysqli_query($conexion,"select * from proveedores where rif_prov='$rif_prov'");
