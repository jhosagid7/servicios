<aside class="right-side">
	...
	<section class="content-header">
		<div class="drop" style="width: 100%;">
			<ul class="drop_menu">
			 <?php if (isset($_SESSION["privilegio"]) and  $_SESSION["privilegio"] == "Administrador"){ ?>
				<li class="dropdown user user-menu">
					<a href="<?php echo BASE_URL?>modulos/mod_administrador/administrador.php" class="dropdown-toggle" data-toggle="dropdown">
				...
				<li class="dropdown user user-menu">
					...
					<ul>
						...
						<li><a href='<?php echo BASE_URL?>modulos/mod_administrar_usuarios/administrar_usuarios.php'><i class="glyphicon glyphicon-user"> Usuarios</i> </a></li>
						<?php
				}else{ ?>
						<li><a href='<?php echo BASE_URL?>modulos/mod_administrar_empresa/administrar_empresa.php'><i class="glyphicon glyphicon-globe"> Empresa</i> </a></li>
						<li><a href='<?php echo BASE_URL?>modulos/mod_administrar_control/administrar_control.php'><i class="glyphicon glyphicon-list-alt"> Reportes</i> </a></li>
